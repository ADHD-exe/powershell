...
function Get-Git-MainBranch { git symbolic-ref refs/remotes/origin/HEAD 2>$null | Split-Path -Leaf }
function Get-Git-CurrentBranch { git rev-parse --abbrev-ref HEAD 2>$null }
